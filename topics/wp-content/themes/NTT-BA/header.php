							...
							<div>
								<ul class="nav navbar-nav container-fluid">
									...
									<li class="dropdown hidden-xs">
										<a><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span>サービスメニュー</a>
									...
									<li class="dropdown hidden-xs">
										<a><span class="glyphicon glyphicon-triangle-right" aria-hidden="true"></span>導入事例</a>
										<ul class="dropdown-menu gnavi-sub">
